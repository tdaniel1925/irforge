...
const GUIDES = [
  ...
  },
  {
    ...
    a: "A quiet period is a window — typically around earnings or a securities offering — when you limit what you say publicly to avoid selectively disclosing or hyping ahead of material news. There's no single legal definition for the earnings blackout (it's best practice, usually ~2 weeks before through the release), but offering-related quiet periods are stricter and rule-driven. PubcoZone's quiet mode locks publishing during these windows; the IR Calendar schedules it automatically when you add an earnings date.",
  },
  {
    q: "What does an investor relations program actually do?",
    a: "Good IR does five things: (1) gets your news out fast and clearly, (2) keeps your story visible between announcements so you don't go dark, (3) answers shareholders and corrects misinformation, (4) targets the right institutional investors, and (5) proves to your board that it's working. Agencies charge $5-15k/month to do this with humans. The point of PubcoZone is to do the same jobs at software speed and price — with you approving everything.",
  },
  {
    q: "What's the difference between Section 17(b) and disclosure?",
    a: "Section 17(b) of the Securities Act is the anti-touting rule: anyone PAID to promote a security must clearly disclose that they're compensated, by whom, and how much. It's the most common charge against stock promoters. This is why every post PubcoZone publishes carries a disclosure that the account is run by a compensated service provider — it's not optional, it's the law, and doing it right is what separates a legitimate IR program from a pump scheme.",
  },
];
