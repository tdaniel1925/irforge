...
// Social-account connection management for the company Settings page. Extracted
// from app/settings/page.tsx (which mixed company profile + OAuth + admin in one
// 700-line file). This is the OAuth/publishing-provider surface: per-network
// connect popups, connection health tests, and disconnect.
