  ...
  const embeds = [
    {
      ...
      preview: <img src={`${SITE}/api/badge/${ticker}.svg`} alt="grade" width={248} height={60} />,
    ...
    },
    {
      ...
      preview: <img src={`${SITE}/api/badge/${ticker}/price`} alt="price" width={230} height={44} />,
    ...
    },
    {
      ...
      preview: <img src={`${SITE}/api/badge/${ticker}/verified`} alt="verified" width={230} height={56} />,
    ...
    },
    {
      ...
      preview: <iframe src={`${SITE}/embed/snapshot/${ticker}`} title="snapshot" width={340} height={250} style={{ border: 0, borderRadius: 14 }} />,
    ...
    },
    {
      ...
      preview: <iframe src={`${SITE}/embed/hub/${ticker}`} title="hub" width="100%" height={420} style={{ border: "1px solid var(--c-border)", borderRadius: 14 }} />,
